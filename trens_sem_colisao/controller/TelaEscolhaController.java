...
public class TelaEscolhaController implements Initializable {
  ...
  // solucoes que vao impedir a colisao dos trens
  private String[] solucoes = { "Variavel de Travamento", "Estrita Alternancia", "Solucao de Peterson" };
  // solucao que sera utilizada
  ...
  *************************************************************** */
  ...
  public void botaoClicado(MouseEvent event) {
    try{
      ...
      // aninhamento de ifs que compara a solucao escolhida pelo usuario com o vetor de solucoes que podem ser escolhidas
      // caso onde o usuario escolheu a solucao de variavel de travamento para evitar as colisoes
      if(solucaoDoTremChoiceBox.getValue().equals(solucoes[0])){
        this.setSolucao("variavel_travamento");
      }
      // caso onde o usuario escolheu a solucao de variavel de travamento para evitar as colisoes
      if(solucaoDoTremChoiceBox.getValue().equals(solucoes[1])){
        this.setSolucao("estrita_alternancia");
      }
      if(solucaoDoTremChoiceBox.getValue().equals(solucoes[2])){
        this.setSolucao("peterson");
      }
  ...
  public void setSolucao(String solucao){
    TelaEscolhaController.solucao = solucao;
  }
  ...
  *************************************************************** */
  ...
  public void initialize(URL location, ResourceBundle resources) {
    ...
    // colocando na caixa de escolha os indices contidos no arranjo de strings 'solucoes'
    solucaoDoTremChoiceBox.getItems().addAll(solucoes);
  }
}